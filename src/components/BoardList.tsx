 ...
 * 최근 글은 제목 텍스트 바로 뒤에 'N' 배지를 인라인으로 붙인다(말줄임에 가려지는 행만
 * 첫 줄 오른쪽에 폴백 — BoardTitle). 판정 규칙·배지는 홈 공지 섹션과 같다(lib/new-post).
        ...
        const row = (
          ...
          >
            ...
            <div className="flex flex-col items-start">
              ...
              {/* 제목 + N 배지 (배치 규칙은 BoardTitle 주석 참고) */}
              <BoardTitle title={item.title} newLabel={isNew ? t('newBadge') : undefined} />
              {item.subtitle && (
